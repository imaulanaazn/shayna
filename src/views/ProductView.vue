                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="product-thumbs">
                                    ...
                                    navigation
                                    :space-between="12"
                                    class="product-thumbs-track ps-slider owl-carousel">
                                        <SwiperSlide>
                                            <div :class="`pt ${thumbs[0] == gambar_default ? 'active' : '' }`" @click="changeImage(thumbs[0])">
                                                <img src="img/mickey1.jpg" alt="" />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div :class="`pt ${thumbs[1] == gambar_default ? 'active' : '' }`" @click="changeImage(thumbs[1])">
                                                <img src="img/mickey2.jpg" alt="" />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div :class="`pt ${thumbs[2] == gambar_default ? 'active' : '' }`" @click="changeImage(thumbs[2])">
                                                <img src="img/mickey3.jpg" alt="" />
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div :class="`pt ${thumbs[3] == gambar_default ? 'active' : '' }`" @click="changeImage(thumbs[3])">
